...
unset BOOT_ENTRY BOOT_LUKS_DEVICE CLEAR_CCACHE CONTINUE CRYPTOMOUNT EFI_MOUNTPOINT EFI_UUID GRUB_CONFIG GRUB_LOCAL_CONFIG GRUB_SSH_CONFIG KERNEL_VERSION LUKSCLOSE_BOOT NUMBER_REGEX UMOUNT_BOOT UUID_BOOT_FILESYSTEM UUID_BOOT_LUKS_DEVICE
