...
curl -fsSLO --proto '=https' --tlsv1.3 "https://mirror.leaseweb.com/gentoo/releases/amd64/autobuilds/current-stage3-amd64-hardened-nomultilib-selinux-openrc/${CURRENT_STAGE3}.DIGESTS.asc"
