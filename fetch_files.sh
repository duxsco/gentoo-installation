...
curl -fsSLO --proto '=https' --tlsv1.3 "https://ftp.fau.de/gentoo/snapshots/portage-latest.tar.xz"
curl -fsSLO --proto '=https' --tlsv1.3 "https://ftp-stud.hs-esslingen.de/pub/Mirrors/gentoo/snapshots/portage-latest.tar.xz.gpgsig"
